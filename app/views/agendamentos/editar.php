...
<head>
    ...
    <title>Editar Agendamento — Belezza Studio</title>
...
<body class="body-dashboard">
    <?php $paginaAdminAtiva = 'agendamentos-editar'; include __DIR__ . '/../../../includes/sidebar.php'; ?>

    <header class="admin-topbar">
        <div>
            <h1 class="admin-topbar-titulo">Editar Agendamento</h1>
            <p class="admin-topbar-subtitulo">Atualize os dados do agendamento selecionado</p>
        </div>
    </header>
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <select class="form-select" id="id_cliente" name="id_cliente" required>
                            <option value="2" selected>Maria Eduarda Santos</option>
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select" id="id_profissional" name="id_profissional" required>
                            <option value="1" selected>Juliana Alves — Cabelo</option>
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select" id="id_servico" name="id_servico" required>
                            <option value="1" selected>Corte Feminino — R$ 80,00</option>
